...
for k = 1 : length(t)-1
    ...
    %---Fluctuating Q_opt-----------------------------------------
    if mod( (t(k)-t0), fluctuationDuration(1 + (1 + fluctuationSign)/2 ) ) == 0
...
%save('Results\sol_fluctuation.mat', 'population', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
%save('Results\sol_fluctuation_extinction.mat', 'population', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
