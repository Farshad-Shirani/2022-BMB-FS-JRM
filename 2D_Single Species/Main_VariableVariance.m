...
population.density = zeros(I, J-1, length(storageTimes)); 
population.trait_mean = zeros(I, J-1, length(storageTimes)); 
population.trait_variance = zeros(I, J-1, length(storageTimes));
...
%save('Results\sol_heterogeneousCapacity.mat', 'population', 'modelParameters', 'simulationParameters', 'discretizationParamaters');
